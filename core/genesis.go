...
func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, overrideBerlin *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	// The full node of two UNIQA testnets may run without genesis file after been inited.
	if genesis == nil && stored != params.MainnetGenesisHash &&
		stored != params.ChapelGenesisHash && stored != params.RialtoGenesisHash && stored != params.UNIQAGenesisHash {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.UNIQAGenesisHash:
		return params.UNIQAChainConfig
